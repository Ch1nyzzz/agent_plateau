...
# Output file for launch commands
OUTPUT_FILE = "launch_commands.txt"
...
with open(OUTPUT_FILE, 'w') as f:
    for seed in SEEDS:
        for bm_idx, benchmark_meta in enumerate(benchmark_metas):
            ...
            num_threads = getattr(benchmark_meta, 'num_threads', None) or 8
